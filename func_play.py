...
def run_fast(path="./agent.pth", secs=60, speed=.4, parallel=game_parallel.PresentHunterParallel, g_ui=game_ui.PresentHunterUI, n_hidden=200):
    agent = func_learn.load(rl_net.ModelAgent(4, 2, [1], False, n_hidden=n_hidden), path, 'cpu')
